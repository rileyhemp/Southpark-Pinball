...
function createStaticObjects(scene) {
  ...
  new Sensor(scene, 303, 200, 30, 20, -.1, 'ramp-on', 'rightRampOn', sensorGroupA); //Ramp off
  ...
  new Sensor(scene, 255, 262, 120, 20, 0, 'all-ramps-off', 'allRampsOff', sensorGroupB); //Ramp hit
  ...
  new Sensor(scene, 349, 16, 60, 20, -.1, 'ramp-hit', 'rightRampHit', sensorGroupB); //Loop hit
  ...
  new Sensor(scene, 378, 262, 30, 20, -.1, 'loop-on', 'rightLoopOn', sensorGroupB); //Cartman hit
  ...
  new Sensor(scene, 435, 477, 30, 20, 1.6, 'launcher-on', 'launcherOn', sensorGroupA); //Launcher off

  new Sensor(scene, 349, 100, 80, 20, -.1, 'launcher-off', 'launcherOff', sensorGroupA); //Butters

  new Sensor(scene, 356, 218, 30, 10, .3, 'target', 'butters', sensorGroupA); //Rails 

  new Sensor(scene, 107, 47, 30, 20, 0, 'rail', null, sensorGroupB);
  new Sensor(scene, 408, 47, 30, 20, 0, 'rail', null, sensorGroupB);
}
//# sourceMappingURL=static-objects.js.map
